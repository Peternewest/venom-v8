...
TOKEN = '8036940975:AAEp8vv57FGLk3lCysri34O-5EPYrCof3Qw'
bot = telebot.TeleBot(TOKEN, threaded=False)

# 🛡️ List of authorized user IDs (replace with actual IDs)
AUTHORIZED_USERS = [6009363155,5303614155]
...
def start(message):
    ...
    if user_id not in AUTHORIZED_USERS:
        bot.send_message(message.chat.id, "🚫 Access Denied! Contact the owner for assistance: @Selffiisshh_Person")
    else:
        welcome_message = (
            ...
            "📞 Contact the owner on Instagram and Telegram: @Selffiisshh_Person\n"
...
def show_id(message):
    ...
    bot_owner = "@Selffiisshh_Person"  # 👑 The bot owner's username  ⋆｡ﾟ☁︎｡⋆｡ ﾟ☾ ﾟ｡⋆⋆｡ﾟ☁︎｡⋆｡ ﾟ☾ ﾟ｡⋆
...
def owner(message):
    ...
    bot.send_message(message.chat.id, "📞 Contact the owner: @Selffiisshh_Person")
...
This bot is owned and operated by @Selffiisshh_Person on Telegram and on Instagram, 🇮🇳. By using this bot, you acknowledge that you understand and agree to the following terms:
...
* **🚫 LIMITATION OF LIABILITY**: The owner and operator of this bot, shall not be liable for any damages or losses arising from the use of this bot, including but not limited to direct, indirect, incidental, punitive, and consequential damages, including loss of profits, data, or business interruption.
...
* **🤝 INDEMNIFICATION**: You agree to indemnify and hold harmless @Selffiisshh_Person on Telegram, and its affiliates, officers, agents, and employees, from and against any and all claims, damages, obligations, losses, liabilities, costs or debt, and expenses (including but not limited to attorney's fees) arising from or related to your use of this bot.
* **🌐 THIRD-PARTY LINKS**: This bot may contain links to third-party websites or services, and you acknowledge that @Selffiisshh_Person on Telegram is not responsible for the content, accuracy, or opinions expressed on such websites or services.
* **🔄 MODIFICATION AND DISCONTINUATION**: You agree that @Selffiisshh_Person on Telegram may modify or discontinue this bot at any time, without notice, and that you will not be entitled to any compensation or reimbursement for any losses or damages arising from such modification or discontinuation.
...
* **📝 ENTIRE AGREEMENT**: This disclaimer constitutes the entire agreement between you on regarding your use of this bot, and supersedes all prior or contemporaneous agreements or understandings.
...
if __name__ == "__main__":
    ...
    print(" 👍 Bot is now online with @Selffiisshh_Person Script and ready to Ddos_attack! ▰▱▰▱▰▱▰▱▰▱▰▱▰▱")
